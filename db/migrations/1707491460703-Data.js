module.exports = class Data1707491460703 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "game_finished_for_user" ("id" character varying NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" text NOT NULL, "game_finished_id" character varying, "user_id" character varying, CONSTRAINT "PK_bfc52c304f8f659d2a7610b7f7d" PRIMARY KEY ("id"))`)
        ...
        await db.query(`ALTER TABLE "game_finished_for_user" ADD CONSTRAINT "FK_2b77d97ad199f52bd6ccbb9d7a4" FOREIGN KEY ("game_finished_id") REFERENCES "game_finished"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "game_finished_for_user" ADD CONSTRAINT "FK_d025ae9d32b0ac827a27d9eb982" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
